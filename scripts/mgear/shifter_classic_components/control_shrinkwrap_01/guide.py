...
# guide info
AUTHOR = "Jeremie Passerin, Miquel Campos, Toke Stuart Jepsen"
URL = "www.jeremiepasserin.com, www.miquel-campos.com, www.bumpybox.com"
EMAIL = ""
VERSION = [1, 0, 0]
TYPE = "control_shrinkwrap_01"
NAME = "control"
DESCRIPTION = (
    "Simple controler with space switch, Rot order selection and skrinwrap.\n"
...
class Guide(guide.ComponentGuide):
    ...
    def addParameters(self):
        ...
        self.pPlaneSize = self.addParam("planeSize", "double", 1, None, None)
        self.pMesh = self.addParam("mesh", "string", "")
...
class componentSettings(MayaQWidgetDockableMixin, guide.componentMainSettings):
    ...
    def populate_componentControls(self):
        ...
        self.settingsTab.planeSize_doubleSpinBox.setValue(
            self.root.attr("planeSize").get())
        self.settingsTab.mesh_lineEdit.setText(
            self.root.attr("mesh").get())
    ...
    def create_componentConnections(self):
        ...
        self.settingsTab.ctlSize_doubleSpinBox.valueChanged.connect(
            partial(self.updateSpinBox,
                    ...
                    "ctlSize"))
        self.settingsTab.planeSize_doubleSpinBox.valueChanged.connect(
            partial(self.updateSpinBox,
                    self.settingsTab.planeSize_doubleSpinBox,
                    "planeSize"))
        self.settingsTab.mesh_pushButton.clicked.connect(
            partial(self.updateMesh,
                    self.settingsTab.mesh_lineEdit,
                    "mesh"))
