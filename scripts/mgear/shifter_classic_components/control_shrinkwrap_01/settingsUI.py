...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.planeSize_label = QtWidgets.QLabel(self.groupBox)
        self.planeSize_label.setObjectName("planeSize_label")
        self.horizontalLayout_3.addWidget(self.planeSize_label)
        self.planeSize_doubleSpinBox = QtWidgets.QDoubleSpinBox(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.planeSize_doubleSpinBox.sizePolicy().hasHeightForWidth())
        self.planeSize_doubleSpinBox.setSizePolicy(sizePolicy)
        self.planeSize_doubleSpinBox.setWrapping(False)
        self.planeSize_doubleSpinBox.setAlignment(QtCore.Qt.AlignCenter)
        self.planeSize_doubleSpinBox.setButtonSymbols(QtWidgets.QAbstractSpinBox.PlusMinus)
        self.planeSize_doubleSpinBox.setMinimum(0.01)
        self.planeSize_doubleSpinBox.setMaximum(20000.0)
        self.planeSize_doubleSpinBox.setProperty("value", 1.0)
        self.planeSize_doubleSpinBox.setObjectName("planeSize_doubleSpinBox")
        self.horizontalLayout_3.addWidget(self.planeSize_doubleSpinBox)
        self.verticalLayout_4.addLayout(self.horizontalLayout_3)

        self.horizontalLayout_4 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.mesh_label = QtWidgets.QLabel(self.groupBox)
        self.mesh_label.setObjectName("mesh_label")
        self.horizontalLayout_4.addWidget(self.mesh_label)
        self.mesh_lineEdit = QtWidgets.QLineEdit(self.groupBox)
        self.mesh_lineEdit.setObjectName("mesh_lineEdit")
        self.horizontalLayout_4.addWidget(self.mesh_lineEdit)
        self.mesh_pushButton = QtWidgets.QPushButton(self.groupBox)
        self.mesh_pushButton.setObjectName("mesh_pushButton")
        self.horizontalLayout_4.addWidget(self.mesh_pushButton)
    ...
    def retranslateUi(self, Form):
        ...
        self.planeSize_label.setText(gqt.fakeTranslate("Form", "Plane Size", None, -1))
        self.mesh_label.setText(gqt.fakeTranslate("Form", "Mesh", None, -1))
        self.mesh_pushButton.setText(gqt.fakeTranslate("Form", "<<", None, -1))
